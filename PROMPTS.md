...
- **Ferramenta**: Gemini
- **O que fiz**: Comecei enviando o PDF da atividade (_FE2_Atividade-Vitrine-Alegre_) para a IA e pedi para construirmos o passo a passo da aplicação "Vitrine Alegre" em React e Vite, exigindo que ela me explicasse cada parte para que eu pudesse entender.
